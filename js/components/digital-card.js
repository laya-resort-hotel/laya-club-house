      ...
      >
        <div class="digital-card-flip-inner">
          <section class="digital-card digital-card-face digital-card-front fitness-card-image-shell" aria-hidden="false">
            <img class="fitness-card-image" src="${FITNESS_GUEST_FRONT_IMAGE}" alt="Fitness Guest member card front" loading="eager" decoding="sync" fetchpriority="high" referrerpolicy="no-referrer">
          </section>

          <section class="digital-card digital-card-face digital-card-back fitness-card-image-shell" aria-hidden="true">
            <img class="fitness-card-image" src="${FITNESS_GUEST_BACK_IMAGE}" alt="Fitness Guest member card back" loading="eager" decoding="sync" fetchpriority="high" referrerpolicy="no-referrer">
            <div class="fitness-qr-slot" aria-label="QR code area">
              <div class="qr-box qr-box-image fitness-qr-box">
                <img src="${qrImage}" alt="QR code for ${cardNumber}" loading="eager" decoding="sync" fetchpriority="high" referrerpolicy="no-referrer">
              </div>
            </div>
          </section>
        </div>

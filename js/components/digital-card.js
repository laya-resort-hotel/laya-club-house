...
function renderCardFront({ user, card, theme, cardType, cardNumber, qrValue, qrImage, themeConfig }) {
  return `
...
export function renderDigitalCard(user = {}, card = null, theme = null) {
  ...
  const qrImage = getQrImageUrl(qrValue, 160);
    ...
    <div class="digital-card-widget" data-card-flip-widget>
      ...
      >
        <div class="digital-card-flip-inner">
          ${renderCardFront({ user, card, theme, cardType, cardNumber, qrValue, qrImage, themeConfig })}
